            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-end">{{ __('auth.postal_code') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('auth.country') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="referral_code" class="col-md-4 col-form-label text-md-end">{{ __('auth.referral_code') }}</label>
                            <div class="col-md-6">
